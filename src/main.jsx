...
const navLinks = [
  { name: 'Home', id: 'home', href: '#home', subtitle: 'Growth Partner in UAE' },
  { name: 'SEO & Digital', id: 'digital', href: '#digital', subtitle: 'Turn Visibility Into Results' },
  ...
  { name: 'Contact', id: 'contact', href: '#contact', subtitle: "Let's Grow Your Brand" },
];
    ...
    <>
      <header className={`header ${scrolled ? 'scrolled' : ''}`}>
        <div className="header-container">
          {/* Logo */}
          <a href="#" className="brand-logo" aria-label="XPATZHUB home" onClick={noop}>
            ...
            <div className="nav-links-wrap">
              {navLinks.map(link => (
                <a
                  ...
                  className={`nav-link ${link.id === 'home' ? 'active' : ''}`}
                  onClick={noop}
                >
                  <span>{link.name}</span>
                </a>
