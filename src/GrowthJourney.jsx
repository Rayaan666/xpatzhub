    ...
    <div className="growth-inner">
      ...
      <div className="growth-journey">
        ...
        <ol className="growth-panels">
          {growthContent.stages.map((stage,index)=><React.Fragment key={stage.category}>
            <li className="growth-stage">
            ...
            {index < growthContent.stages.length - 1 && (
              <button
                type="button"
                className="growth-transition"
                aria-label={`Continue to stage ${index + 2}: ${growthContent.stages[index + 1].title}`}
                onClick={() => focusStage(index + 1)}
              >
